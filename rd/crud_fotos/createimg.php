...
if ($_FILES['head_imagen']['name'] != null) {
    ...
    $query = "UPDATE rd_inicio_fin set FOTOS = 'SI' WHERE Id_SERG ='$idp'"; mysqli_query($conexion, $query);
...
switch ($Redirigir) {
              ...
              case 'ruta_ruta':
                  ...
                  $query = "UPDATE hruta set hr_foto = 'SI' WHERE id_serv ='$idr'"; mysqli_query($conexion, $query);
                  break;
