...
<div class="camera-gallery-container" style="display: flex !important;">
...
<script>
    ...
    document.getElementById('head_imagen').addEventListener('change', function(e) {
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    window.openCamera = function () {
      if (!fileInput) {
        alert('No se encontró el input de archivo (head_imagen).');
        return;
      }
