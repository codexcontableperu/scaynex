...
switch ($i) {
    case 1:
          ...
          $query = "UPDATE rd_inicio_fin set h_inicio = '$txt' WHERE Id_SERG ='$idp'";
    ...
    case 12:
          ...
          $query = "UPDATE rd_inicio_fin set t_inicio = '$txt'  WHERE Id_SERG ='$idp'";
          mysqli_query($conexion, $query);
          mysqli_close($conexion);
    ...
    case 200:
          ...
          $query = "UPDATE rd_inicio_fin set HORA_SALIDA_BASE = '$txt' WHERE Id_SERG ='$idp'";
          mysqli_query($conexion, $query);
          $query = "UPDATE rd_segimientos_head SET  ESTADO_IDP = 1  WHERE Id_SERG = $idp";
          mysqli_query($conexion, $query);
          mysqli_close($conexion);
    ...
    case 2200:
          ...
          $query = "UPDATE rd_inicio_fin set TEMP_SALIDA_BASE = '$txt' WHERE Id_SERG ='$idp'";
          mysqli_query($conexion, $query);
          mysqli_close($conexion);
    ...
    case 2000:
          $query = "UPDATE rd_inicio_fin set KM_SALIDA_BASE = '$txt' WHERE Id_SERG ='$idp'";
          mysqli_query($conexion, $query);
          mysqli_close($conexion);        
          break;
    ...
    case 8:
          $query = "UPDATE rd_inicio_fin set h_retorno = '$txt' WHERE Id_SERG ='$idp'";
          mysqli_query($conexion, $query);
          mysqli_close($conexion);        
          break;

    case 8800: 
          $query = "UPDATE rd_inicio_fin set TEMP_LLEGADA_BASE = '$txt' WHERE Id_SERG ='$idp'";
          mysqli_query($conexion, $query);
          mysqli_close($conexion);        
          break;
    case 8000:
          $query = "UPDATE rd_inicio_fin set KM_LLEGADA_BASE = '$txt' WHERE Id_SERG ='$idp'";
          mysqli_query($conexion, $query);
...
$KM_RECORRIDO=$KM_LLEGADA-$KM_SALIDA;
    ...
    case 800: 
          $query = "UPDATE rd_inicio_fin set HORA_LLEGADA_BASE = '$txt' WHERE Id_SERG ='$idp'";
          mysqli_query($conexion, $query);
...
$hr_recorrido = $horas_recorrido . 'h ' . str_pad($minutos_recorrido, 2, '0', STR_PAD_LEFT) . 'm';
    ...
    case 90:
          $query = "UPDATE rd_inicio_fin set ruta_obs = '$txt' WHERE Id_SERG ='$idp'";
          mysqli_query($conexion, $query);
          mysqli_close($conexion);        
          break;        
