    ...
    <option value="JS GREGORI" > JS GREGORI </option>         
       ...
       <input class="form-control ancho" list="temp" type="text" id="TEMPERATURA" name="TEMPERATURA" value='<?php echo $filas ['TEMPERATURA'];?>' placeholder="Temperatura " required >
        ...
        <td style="text-align:left;">
          ...
          <input class="form-control ancho" list="NOMBRES" type="text" id="CONDUCTOR" name="CONDUCTOR" value='<?php echo $filas ['CONDUCTOR'];?>'placeholder="Conductor " required >
          <datalist id="NOMBRES" >  
          <option selected ></option>
              <?php               
      ...
      <td style="text-align:left;">
          ...
          <input class="form-control ancho" list="AUX1" type="text" id="AUXILIAR1" name="AUXILIAR1" value='<?php echo $filas ['AUXILIAR1'];?>' placeholder="Auxiliar 01 " >
          <datalist id="AUX1" >  
          <option selected ></option>
              <?php 
                $queryP="SELECT user_nombre, user_disponible FROM usuarios WHERE user_disponible ='si'";
          ...
          <input class="form-control ancho" list="AUX2" type="text" id="AUXILIAR2" name="AUXILIAR2" value='<?php echo $filas ['AUXILIAR2'];?>' placeholder="Auxiliar 02 " >
          <datalist id="AUX2" >  
          <option selected ></option>
              <?php 
                $queryP="SELECT user_nombre, user_disponible FROM usuarios WHERE user_disponible ='si'";
          ...
          <input class="form-control ancho" list="AUX3" type="text" id="AUXILIAR3" name="AUXILIAR3" value='<?php echo $filas ['AUXILIAR3'];?>'placeholder="Auxiliar 03 "  >
          <datalist id="AUX3" >  
          <option selected ></option>
              <?php 
                $queryP="SELECT user_nombre, user_disponible FROM usuarios WHERE user_disponible ='si' ";
